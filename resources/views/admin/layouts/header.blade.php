			...
			<ul class="navbar-nav float-right">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right user-dd animated">
						@if (Auth::user())
						<a class="dropdown-item" href="{{url('/profile-page/'.Auth::user()->id)}}"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
						@else
						<a class="dropdown-item" href="{{url('/profile-page/')}}"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
						@endif
