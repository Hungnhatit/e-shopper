            ...
            <div class="col-sm-9">
                <div class="blog-post-area">
                    ...
                    <div class="signup-form"><!--sign up form-->
                        ...
                        <form action="{{'/ecommerce/update-product/'.$product['id']}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div style="display: flex;">
                                <img style="width: 72px;" src="{{asset('upload/product/'.$image)}}" alt="">
                                <input type="checkbox" value="{{$image}}" name="imageCheckbox[]" multiple>
                            </div>
                            @endforeach

                            <textarea name="detail" id="" placeholder="Detail" value="{{$product['detail']}}"></textarea>
