                ...
                <form action="/send-mail" method="POST">
                    ...
                    <div class="col-sm-5 clearfix">
                        <div class="bill-to">
                            ...
                            <div class="form-one">
                                <form>
                                    <input type="text" name="username" value="{{$user['name']}}" placeholder="{{$user['name']}}">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href=""><img style="width: 100px;" src="{{asset('upload/product/'.json_decode($item['image'])[0])}}" alt=""></a>
                        </td>
